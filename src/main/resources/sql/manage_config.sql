...
-- ----------------------------
INSERT INTO `manage_config` VALUES ('2c918210-5bad7b38-015b-ad7b38f3-0000', 'CA_CERT_PATH', '/etc/pki/CA/keys/', '证书保存路径', null);
INSERT INTO `manage_config` VALUES ('2c918210-5bad7b38-015b-ad7b38f3-0044', 'CRL_DOWNLOAD_PATH', 'http://localhost:8090/ucas-ca/cert/crl', 'crl列表下载路径', null);
INSERT INTO `manage_config` VALUES ('ff808081-5bae4db8-015b-ae4db872-0000', 'CA_CONFIG_PATH', '/etc/pki/tls/openssl.cnf', 'openssl配置文件路径', null);
INSERT INTO `manage_config` VALUES ('ff808081-5bae4db8-015b-ae4db872-0256', 'CRL_FILE_ID', 'crlfile', 'crl列表在mongodb保存的id', null);
...
-- ----------------------------
INSERT INTO `manage_module` VALUES ('08c3b96c-c0f4-4214-86fe-08bfb77147e9', '组织管理描述', '4', '', 'pages/organization/index.js', '2', '组织管理', '0', null);
INSERT INTO `manage_module` VALUES ('1', '统一认证管理系统', '1', '0', '', '0', '统一认证管理系统', '0', null);
INSERT INTO `manage_module` VALUES ('2', '系统管理', '1', '0', '', '1', '系统管理', '0', '	icon-menu-icon');
INSERT INTO `manage_module` VALUES ('3', '用户管理', '1', '0', 'pages/user/index.js', '2', '用户管理', '1', null);
INSERT INTO `manage_module` VALUES ('4', '菜单管理', '3', '0', 'pages/module/index.js', '2', '菜单管理', '1', null);
INSERT INTO `manage_module` VALUES ('5', '角色管理', '2', '0', 'pages/role/index.js', '2', '角色管理', '1', null);
INSERT INTO `manage_module` VALUES ('6', '权限管理', '4', '0', 'pages/permission/index.js', '2', '权限管理', '1', null);
INSERT INTO `manage_module` VALUES ('7', '参数管理', '4', '0', 'pages/config/index.js', '2', '参数管理', '1', null);
INSERT INTO `manage_module` VALUES ('def06628-a916-47bd-97a2-31b4768fc0a3', '定时管理', '6', '', 'pages/schedule/index.js', '2', '定时管理', '0', null);
INSERT INTO `manage_module` VALUES ('ff808081-5c336850-015c-33685078-0000', '测试菜单', '2', null, '', '1', '测试菜单', '0', 'icon-menu-icon1');
INSERT INTO `manage_module` VALUES ('ff808081-5c336850-015c-336abf2f-0001', '业务功能1', '1', null, '', 'ff808081-5c336850-015c-33685078-0000', '业务功能1', '0', '');
...
INSERT INTO `manage_role` VALUES ('2c9182d4-5a1c3f70-015a-1c3f7089-0011', '录入岗', '录入岗1');
...
-- ----------------------------
-- Table structure for manage_user_oauth2_rel
-- ----------------------------
DROP TABLE IF EXISTS `manage_user_oauth2_rel`;
...
-- ----------------------------
-- Records of manage_user_oauth2_rel
-- ----------------------------
INSERT INTO `manage_user_oauth2_rel` VALUES ('uuidtest001', '7d78f855795e279ec71a233a6c399bb3', '7ebbb432-fbf8-44d2-8fad-e9faddae970c');
...
INSERT INTO `manage_user_role` VALUES ('20504610-c2d1-4d49-b0cc-0652a37a8bf5', '2c9182d4-5a1c3f70-015a-1c3f7089-0000', '7ebbb432-fbf8-44d2-8fad-e9faddae970c', null);
