...
module.exports = React.createClass({
    ...
    init: function(sign, data, successFn) {// sign: bind or unbind
    	...
    	if(sign == "bind") {
    		title = "绑定用户";
    		gridUrl = "role/queryUnbindUserList?roleId=" + data.roleId + "&type=" + data.type;
    		saveUrl = "role/bindUser";
    	} else {
    		title = "解绑用户";
    		gridUrl = "role/queryBindUserList?roleId=" + data.roleId + "&type=" + data.type;
			...
			<div>
				<div className="panel">
					...
					<div className="panel-content">
						<FormItem label="用户账号"><Input ref="account"/></FormItem>
