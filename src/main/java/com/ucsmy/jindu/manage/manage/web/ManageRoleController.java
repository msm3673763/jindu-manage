...
public class ManageRoleController {
	...
	@ResponseBody
	public PageResult<ManageRole> queryRoleList(@RequestParam(required = false) String name, @RequestParam(required = true) int pageNum,
	...
	public PageResult<ManageUserRole> queryUnbindUserList(@RequestParam(required = false) String roleId,
			@RequestParam(required = true) String type, @RequestParam(required = false) String name,
			@RequestParam(required = false) String account, @RequestParam(required = true) int pageNum, 
			@RequestParam(required = true) int pageSize) {
		return manageUserRoleService.queryUnbindUserList(roleId, type, name, account, pageNum, pageSize);
	}

	@RequestMapping("bindUser")
	@ResponseBody
	public AosResult bindUser(@RequestParam(required = true) String roleId, @RequestParam(required = true) String userIds) {
	...
	public PageResult<ManageUserRole> queryBindUserList(@RequestParam(required = false) String roleId,
		...
		return manageUserRoleService.queryUserRoleList(roleId, name, type, account, pageNum, pageSize);
	}
