...
import com.ucsmy.jindu.manage.config.shiro.csrf.token.Token;
...
public class HttpSessionCsrfTokenRepository implements CsrfTokenRepository {
	...
	@Autowired
	private ManageUserOauth2RelMapper manageUserOauth2RelMapper;
	...
	/****
	 * 是否由统一认证登录成功回调 1.来源有统一认证标识 2.请求带code参数
	 * 
	 * @return
	 */
	@Override
