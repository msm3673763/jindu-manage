package com.ucsmy.jindu.manage.config.quartz.service.impl;
...
import com.ucsmy.jindu.manage.config.quartz.service.ScheduleService;
import com.ucsmy.jindu.manage.config.quartz.util.ScheduleStatus;
import com.ucsmy.jindu.manage.config.quartz.util.ScheduleTaskNetwork;
import com.ucsmy.jindu.manage.manage.dao.ManageIpScheduleTaskMapper;
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    private void proceed() throws Exception {
        ...
        List<ManageIpScheduleTask> list = manageIpScheduleTaskMapper.getAll();
