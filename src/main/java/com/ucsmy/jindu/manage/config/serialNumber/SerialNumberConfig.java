package com.ucsmy.jindu.manage.config.serialNumber;


import com.ucsmy.jindu.manage.commons.base.utils.StringUtils;
import com.ucsmy.jindu.manage.config.serialNumber.getter.AbstractSerialNumberGenerator;
import com.ucsmy.jindu.manage.config.serialNumber.getter.SerialNumberDBGenerator;
import com.ucsmy.jindu.manage.config.serialNumber.getter.SerialNumberDefaultGenerator;
import com.ucsmy.jindu.manage.config.serialNumber.getter.SerialNumberRedisGenerator;
import com.ucsmy.jindu.manage.config.serialNumber.util.SerialNumberInfo;
