package com.ucsmy.jindu.manage.commons.base.interceptor.utils;
 ...
 * Created by 
 * @author ucs_zhongtingyuan on 2017/4/7.
 */
public class MSUtils {
    ...
    public static MappedStatement newCountMappedStatement(MappedStatement ms) {
        MappedStatement.Builder builder = new MappedStatement.Builder(ms.getConfiguration(), ms.getId() + COUNT, ms.getSqlSource(), 
