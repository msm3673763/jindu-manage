...
public class StringAndNumberUtil{
	...
	public static void main(String[] args){
		String sql = "insert into manage_module(module_id, description, priority, url, parent_id, name, image ) values('2c918200-5caae695-015c-ab039ae9-0005', ?, ?, ?, ?, ?, ? )";
		sql = sql.replaceFirst("\\?", "'!@#\\$%^&*()_+{}}:\"|<>?'");
